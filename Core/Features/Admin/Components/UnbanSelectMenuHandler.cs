...
/// </summary>
public class UnbanSelectMenuHandler(AdminService adminService, ILoggingService logger): InteractionModuleBase<SocketInteractionContext> {
    ...
    [ComponentInteraction(CustomIds.UnbanSelectPattern)]
