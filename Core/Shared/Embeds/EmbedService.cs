...
namespace Lyuze.Core.Shared.Embeds {
    public class EmbedService(IEmbedColorProvider embedColorService, IPlayerService playerService) {
        ...
        public async Task<Embed> ProfileEmbedAsync(SocketGuildUser user, InteractionContext ctx) {
